...
const ShareButtons = ({ result, userInfo, shareId }: ShareButtonsProps) => {
    ...
    return (
        <div className="flex gap-4 justify-center mt-6">
            ...
            {/* Discord Share */}
            <button onClick={shareDiscord} className="bg-[#5865F2] p-2 rounded-full hover:opacity-80 transition-opacity flex items-center justify-center shadow-md w-12 h-12" title="Share on Discord">
