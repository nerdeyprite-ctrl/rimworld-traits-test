...
const Header = () => {
    ...
    return (
        <header className="w-full bg-[var(--rimworld-panel)] border-b border-[var(--rimworld-border)] p-3 sm:p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 shadow-md">
            <Link href="/" className="text-lg sm:text-xl font-bold text-[var(--rimworld-highlight)] hover:opacity-80 transition-opacity">
                {t('app_title')}
            </Link>
            <nav className="flex flex-wrap items-center justify-center sm:justify-end gap-2 sm:gap-4">
                {/* Creator Links */}
                <div className="hidden sm:flex items-center gap-3 mr-2 border-r border-gray-600/30 pr-4">
